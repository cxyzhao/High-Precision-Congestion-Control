...
if __name__ == "__main__":
	...
	parser.add_argument('--hpcc_mode', dest='hpcc_mode', action='store', type=int, default=0, help="hpcc_mode (0: per port, 1: per queue)")
